/* openvms_support.h - definitions for openvms_support.c
 *
 ...
 */
#ifndef PSYCOPG_OPENVMS_SUPPORT_H
#define PSYCOPG_OPENVMS_SUPPORT_H
...
#endif /* !defined(PSYCOPG_OPENVMS_SUPPORT_H) */
